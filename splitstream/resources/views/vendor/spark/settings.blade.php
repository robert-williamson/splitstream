                        ...
                        <div class="spark-settings-tabs">
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <!-- API Link -->
                                    ...
                                    <li role="presentation">
                                        <a href="#connections" aria-controls="connection" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-television"></i>Live Connections
                                        </a>
                                    </li>
                ...
                <div class="tab-content">
                    ...
                    @endif
                        ...
                        <div role="tabpanel" class="tab-pane" id="connections">
                            @include('spark::settings.connection')
                        </div>
